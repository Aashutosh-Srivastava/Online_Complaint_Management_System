...
class Profile(models.Model):
    ...
    COL=(('Lucknow','Lucknow'),('Kanpur','Kanpur')) #change college names
    COL=(('Lucknow','Lucknow'),('Kanpur','Kanpur')) #change college names
    user =models.OneToOneField(User, on_delete=models.CASCADE,primary_key=True)
    city=models.CharField(max_length=29,choices=COL,blank=False)
...
class Complaint(models.Model):
    ...
    TYPE=(('Management',"Management"),('College',"College"),('Other',"Other"))
    reference_id = models.CharField(max_length=10,blank=False,null=False,unique=True)
